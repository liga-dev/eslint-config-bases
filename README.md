# @capex/eslint-config-bases

<p align="left">
  <a aria-label="Build" href="https://github.com/liga-gpn/capex/actions?query=workflow%3ACI">
...
packages that lives in a [monorepo](https://github.com/liga-gpn/capex).
...
```bash
$ yarn add --dev eslint @capex/eslint-config-bases:"workspace:^"
```
...
module.exports = {
  ...
  extends: [
    "@capex/eslint-config-bases/typescript",
    "@capex/eslint-config-bases/sonar",
    "@capex/eslint-config-bases/regexp",
    "@capex/eslint-config-bases/react",
    "@capex/eslint-config-bases/jest",
    "@capex/eslint-config-bases/rtl",
    "@capex/eslint-config-bases/graphql-schema",
    "@capex/eslint-config-bases/storybook",
    "@capex/eslint-config-bases/playwright",
    ...
    "@capex/eslint-config-bases/prettier",
  ],
  rules: {
...
> **Tip:** "@capex/eslint-config-bases/prettier" must be set at the end to disable any
> conflicting rules.
...
To prevent conflicts between prettier and eslint, you must re-export the prettier base from `@capex/eslint-config-bases`.

```javascript
const { getPrettierConfig } = require("@capex/eslint-config-bases/helpers");
module.exports = {
  ...prettierConfig,
  overrides: [
    // whatever you need
